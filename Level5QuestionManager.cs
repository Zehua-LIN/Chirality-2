...
public class Level5QuestionManager : MonoBehaviour
{
	...
	public void displayQuestion() {
		if (numberOfQuestionsAnswred < 5) {
            ...
            string rdscore = qtnRoundScore.ToString() + ",";
            if (!PlayerPrefs.HasKey("Level_5_Scores"))
            {
                PlayerPrefs.SetString("Level_5_Scores", rdscore);
            }
            else
            {
                string tscores = PlayerPrefs.GetString("Level_5_Scores");

                tscores += rdscore;
                PlayerPrefs.SetString("Level_5_Scores", tscores);
            }
            ...
            if (!PlayerPrefs.HasKey("Level_5_Times"))
            {
                PlayerPrefs.SetString("Level_5_Times", sttime);
            }
            else
            {
                string tsttime = PlayerPrefs.GetString("Level_5_Times");
                tsttime += sttime;
