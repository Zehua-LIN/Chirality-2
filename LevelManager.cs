...
//			}
	...
	void endGame() {
        ...
        if (!PlayerPrefs.HasKey("Level_2_Modes"))
        {
            PlayerPrefs.SetString("Level_2_Modes", stmode + ",");
        }
        else
        {
            string modes = PlayerPrefs.GetString("Level_2_Modes");
            modes += mode + ",";
            PlayerPrefs.SetString("Level_2_Modes", stmode);
        }

        if (!PlayerPrefs.HasKey("Level_2_High_Percentage"))
        {
            PlayerPrefs.SetString("Level_2_Percentages", t.ToString() + ",");
        }
        else
        {
            string tscores = PlayerPrefs.GetString("Level_2_Percentages");

            tscores += t.ToString() + ",";
            PlayerPrefs.SetString("Level_2_Percentages", tscores);
        }
        ...
        PlayerPrefs.SetFloat("Time_P", t);

        if (!PlayerPrefs.HasKey("Level_2_Time"))
        {
            PlayerPrefs.SetFloat("Level_2_Time", t);
        }


        if (!PlayerPrefs.HasKey("Level_2_Times"))
        {
            PlayerPrefs.SetString("Level_2_Times", t + ",");
        }
        else
        {
            string tsttime = PlayerPrefs.GetString("Level_2_Times");
            tsttime += t + ",";
            PlayerPrefs.SetString("Level_2_Times", tsttime);
        }
