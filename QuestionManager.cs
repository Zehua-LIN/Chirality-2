			...
			switch (gameLevel)
			{
				case 1:
					if(!PlayerPrefs.HasKey("Level_1_High_Percentage")) {
                        ...
                        if (!PlayerPrefs.HasKey("Level_1_High_Percentage"))
                        {
                            PlayerPrefs.SetString("Level_1_Percentages", percetange.ToString() + ",");
                        }
                        else
                        {
                            string tscores = PlayerPrefs.GetString("Level_1_Percentages");
                        ...
                        if (!PlayerPrefs.HasKey("Level_1_Times"))
                        {
                            PlayerPrefs.SetString("Level_1_Times", sttime);
                        }
                        else
                        {
                            string tsttime = PlayerPrefs.GetString("Level_1_Times");
                            tsttime += sttime + ",";
				...
				case 3:
					if(!PlayerPrefs.HasKey("Level_3_High_Percentage")) {
                        ...
                        if (!PlayerPrefs.HasKey("Level_3_High_Percentage"))
                        {
                            PlayerPrefs.SetString("Level_3_Percentages", percetange + ",");
                        }
                        else
                        {
                            string tscores = PlayerPrefs.GetString("Level_3_Percentages");
                        ...
                        if (!PlayerPrefs.HasKey("Level_3_Times"))
                        {
                            PlayerPrefs.SetString("Level_3_Times", sttime);
                        }
                        else
                        {
                            string tsttime = PlayerPrefs.GetString("Level_3_Times");
                            tsttime += sttime + ",";
